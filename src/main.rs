...
fn main() -> io::Result<()> {
    ratatui::run(|terminal: &mut ratatui::prelude::Terminal<ratatui::prelude::CrosstermBackend<io::Stdout>>| App::default().run(terminal))?;
    Ok(())
}
...
impl Widget for &App {
    fn render(self, area: Rect, buf: &mut Buffer) {
        let title: Line<'_> = Line::from(" HYDOCO ".bold());
